...
HelloRails is an app that demonstrates the ability of a user to create Rails and React as one application. The front end link to the repo is [Frontend Repo](https://github.com/Kanyorok/hello-react-frontend)
